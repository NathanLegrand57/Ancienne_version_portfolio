...
<body>
    ...
    <div class="part1">
        ...
        <ul>
            ...
            <li>Services Cognitifs et Intelligence Artificielle (pas à Nantes)</li>
        </ul>
        ...
        <div class="infos_exakis">
            <img id="infos_exakis" src="./assets/infos_exakis_nelite.png" alt="Informations sur Exakis Nelite" title="Informations sur Exakis Nelite">
        </div>
    </div>
    <div class="part2">
        ...
        <p>Lors de mon premier jour, j'ai regardé le portail intranet de la société pour voir comment les employés
            ...
            stage. Les autres jours de la semaine, j'ai intégré l'équipe "Modern Workplace" spécialisée dans les services <strong>Microsoft Power Platform</strong> (un ensemble d'applications logicielles) et c'est pourquoi je me suis formé dessus en
    ...
    <div class="create_activity">
        ...
        <div class="part2">
            ...
            <!-- <p> Après avoir fini toutes ces tâches, j'ai pu assister à une <strong>revue de projet</strong> où le chef d'équipe revoyait avec tous
                les
                membres de l'équipe un projet terminé. Il contextualisait la <strong>problématique</strong> du client,
                présentait le <strong>cahier des charges</strong>, montrait ce qui avait été fait, comment et avec quels
                moyens et les difficultés rencontrées au cours du projet.</p> -->

            <p>Par la suite, j'ai eu l'occasion d'intégrer l'équipe "<strong>CSV</strong>" et de me former au
                <em>C#</em> et <em>Xamarin</em>, et utiliser <em>l'IDE Visual Studio</em> (qui est plus complet que Visual Studio Code et plus adéquat pour coder en Xamarin) pendant plus d'une
                semaine pour mieux comprendre ce que font les développeurs de l'équipe qui pratiquent majoritairement dans ce
                langage pour développer des <strong>applications mobiles</strong>. <br />
                Après m'être formé, j'ai découvert sur quoi ils travaillaient au moment où je faisais mon stage. J'ai pu les
                suivre sur une <strong>TMA</strong> (maintenance d'application) où ils devaient corriger des bugs (reportés sur un ticket rédigé par le client) sur
                une
        ...
        <div class="part3">
            <p>
                ...
                Enfin, j'ai fait mon <strong>portfolio</strong> sur la dernière semaine restante car je n'avais plus d'autre activité à faire.
            </p>
        </div>
        <?php
        require("footer.php");
